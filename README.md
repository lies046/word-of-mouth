...
# 2.制作背景
- 最近、プログラミングのスクールやプログラミングの需要が増えていると思います。  
  決して安くはない受講料を払って学習するわけですから実際受講してどうなの？というところが一番知りたいことかと思います。  
  あまりそういうサイトもありませんでしたので受講生や卒業生の声を集めてこれからスクールを選ぶ人たちの道しるべになればと思い開発しました。
...
# 6.工夫した点
- 初めは回答者ごとに表示をさせるプランではありませんでした。  
  しかし、開発を進めていく上でユーザー別でも見れた方がユーザー的にはよいかと思いユーザー別でも表示できるよう変更しました。
- 8つの項目ごとにそれぞれ一覧で見れるよう作りました。

# 7.苦労した点
- とにかく時間との勝負でした。  
  10日間という期間を設けてどれだけ作成することができるのかを試したかったので大変でした。 
- 項目毎やユーザー毎で回答結果を表示させるやり方は初めてやったので苦戦しました。
  トライアンドエラーを繰り返しようやくできました。
- デプロイのサポートをしつつ自分のタスクも消化していた。
